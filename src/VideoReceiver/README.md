...
For supported platforms, QGroundControl implements an UDP RTP and RSTP video streaming receiver in its Main Flight Display. It uses GStreamer and a stripped down version of QtGstreamer. 

EchoMAV builds are now using **GStreamer 1.24.0**. Newer versions of GStreamer may break the build as some dependent libraries may change.
...
#### 64-Bit: 
- [gstreamer-1.0-devel-msvc-x86_64-1.24.0.msi](https://gstreamer.freedesktop.org/data/pkg/windows/1.24.6/msvc/gstreamer-1.0-devel-msvc-x86_64-1.24.0.msi)
- [gstreamer-1.0-msvc-x86_64-1.24.0.msi](https://gstreamer.freedesktop.org/data/pkg/windows/1.24.6/msvc/gstreamer-1.0-msvc-x86_64-1.24.0.msi)
