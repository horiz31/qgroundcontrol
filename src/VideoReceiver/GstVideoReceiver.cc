...
auto const __probe_id__ = gst_pad_add_probe(\
    ...
    {\
            qCDebug(VideoReceiverLog) << "Encountered frame "#__probe_type__" on element "#__pipeline__"-->"#__p_element__" with pad "<<__pad__; \
        ...
        do
        {
            ...
            }
            {
                ...
                g_object_set(p_sourceQueue, "silent", true, nullptr);
                 g_object_set(p_sourceQueue, "leaky", 2, nullptr); // leak older buffers
                __BREAK_IF_FAIL(
            ...
            }
            {
                ...
                __DEBUG_PROBE_FRAME_STATIC(mp_sourcePipeline, p_sourceSink,"sink",GST_PAD_PROBE_TYPE_BUFFER,"mp_sourcePipeline_interpipesink");
    ...
    else
    {
        ...
        do
        {
            ...
            }
            {
                ...
                g_object_set(p_source, //
                             "listen-to", "mp_sourcePipeline->mp_sourceSink",//
                ...
                __BREAK_IF_FAIL(gst_element_sync_state_with_parent(p_source));
                __DEBUG_PROBE_FRAME_STATIC(mp_decodingPipeline, p_source,"src",GST_PAD_PROBE_TYPE_BUFFER,"mp_decodingPipeline_interpipesrc");
            ...
            }
            {
                //create the parser
#if defined(__android__)
                if(m_uri.startsWith("udp265://", Qt::CaseInsensitive))
                {
                    __BREAK_IF_FAIL(
                        p_parser = gst_element_factory_make("rtph265depay",
            ...
            }
            {
                ...
                {
                    __BREAK_IF_FAIL(
                        p_decoder = gst_element_factory_make("avdec_h265",
                                                             "mp_decodingPipeline->decodebin3"));
                }
                else
                {
            ...
            }
            {
                ...
                __DEBUG_PROBE_FRAME_STATIC(mp_decodingPipeline, mp_videoSink,"sink",GST_PAD_PROBE_TYPE_BUFFER,"mp_decodingPipeline");
            }
            {
