...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#946120", "#3a3a3a", "#3399FF")   //fff291
    ...
    DECLARE_QGC_COLOR(mapButtonHighlight,   "#585858", "#be781c", "#585858", "#101fe8")
    DECLARE_QGC_COLOR(mapIndicator,         "#585858", "#be781c", "#585858", "#101fe8")
    DECLARE_QGC_COLOR(mapIndicatorChild,    "#585858", "#766043", "#585858", "#766043")
    DECLARE_QGC_COLOR(colorGreen,           "#009431", "#009431", "#009431", "#009431")
    DECLARE_QGC_COLOR(colorOrange,          "#b95604", "#b95604", "#de8500", "#de8500")
    DECLARE_QGC_COLOR(colorRed,             "#ed3939", "#ed3939", "#ed3939", "#ed3939")
    ...
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,     "#3399FF", "#3399FF")
    ...
    DECLARE_QGC_SINGLE_COLOR(mapMissionTrajectory,          "#101fe8")
