...
public:
    ...
    Q_INVOKABLE void guidedModeDoPosition(const QGeoCoordinate& gotoCoord, bool clockwise);

    /// Command vehicle to move to specified location (altitude is included and relative)
    Q_INVOKABLE void guidedModeGotoLocation(const QGeoCoordinate& gotoCoord);

    /// Command vehicle to move to specified location (altitude is included and relative)
    Q_INVOKABLE void guidedModeGotoLocationAndAltitude(const QGeoCoordinate& gotoCoord, double altitudeRel, bool isClockwise);
    ...
    void sendMavCommandNoAck(int compId, MAV_CMD command, bool showError, float param1 = 0.0f, float param2 = 0.0f, float param3 = 0.0f, float param4 = 0.0f, float param5 = 0.0f, float param6 = 0.0f, float param7 = 0.0f);
...
private slots:
    ...
    void _updateNvTripVersionChange         (QString value);
    //End NextVision
