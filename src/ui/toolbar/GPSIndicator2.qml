...
Item {
    ...
    Component {
        ...
        Rectangle {
            ...
            Column {
                ...
                QGCLabel {
                    id:             gpsLabel
                    text:           (_activeVehicle && _activeVehicle.gps2.count.value >= 0) ? qsTr("GPS 2 Status") : qsTr("GPS Data Unavailable")
                ...
                GridLayout {
                    ...
                    QGCLabel { text: _activeVehicle ? "%1, %2".arg(_activeVehicle.gps2.lat.value.toFixed(7)).arg(_activeVehicle.gps2.lon.value.toFixed(7)) : qsTr("N/A", "No data to display") }
                    QGCLabel { text: qsTr("Position (MRGS):") }
                    QGCLabel { text: _activeVehicle ? _activeVehicle.gps2.mgrs.valueString : qsTr("N/A", "No data to display") }
    ...
    MouseArea {
        anchors.fill:   parent
        onClicked: {
            mainWindow.showIndicatorPopup(_root, gpsInfo2)
        }
    }
}
