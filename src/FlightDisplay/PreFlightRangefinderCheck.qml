...
PreFlightCheckButton {
    ...
    telemetryTextFailure:           qsTr("Warning - Rangefinder data is outside of the expected range and may not be functioning. Please inspect hardware or contact Hybrid Project for support. It is safe to fly without this sensor. Click to acknowledge and proceed.")
