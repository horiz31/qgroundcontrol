                    ...
                    Column {
                        ...
                        SliderSwitch {
                            ...
                            function startMotorTest(motor) {
                                motorTestStatus.text = qsTr(
                                            "Test Running! (Motor " + motor + ")")

                                console.log("Starting motor test for motor " + motor)
                                globals.activeVehicle.motorTest(
                                            motor, _motorTestThrottle,
                                            _motorTestDurationSec, true)
                            }
