    ...
    sourceItem: Item {
        ...
        QGCMapLabel {
            ...
            property string vehicleLabelText: visible ?
                                                  (_adsbVehicle ?
                                                       QGroundControl.unitsConversion.metersToAppSettingsVerticallDistanceUnits(altitude).toFixed(0) + " " + QGroundControl.unitsConversion.appSettingsVerticalDistanceUnitsString + "\n" + callsign :
