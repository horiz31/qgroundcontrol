...
public:
    ...
    DEFINE_SETTINGFACT(defaultTransitionAltitude)
    ...
    DEFINE_SETTINGFACT(camJoystickPitchRollEnableOption)
    ...
    DEFINE_SETTINGFACT(enablePersistentSystemsRssi)
    DEFINE_SETTINGFACT(persistentSystemsIP)
