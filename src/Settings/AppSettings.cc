...
DECLARE_SETTINGSFACT(AppSettings, defaultTransitionAltitude)
...
DECLARE_SETTINGSFACT(AppSettings, defaultConnectionName)
...
DECLARE_SETTINGSFACT(AppSettings, camJoystickPitchRollEnableOption)
...
DECLARE_SETTINGSFACT(AppSettings, allowRunupInChecklist)
DECLARE_SETTINGSFACT(AppSettings, enforceJoystickRequired)
...
DECLARE_SETTINGSFACT(AppSettings, multicastTelemetryGroup)
