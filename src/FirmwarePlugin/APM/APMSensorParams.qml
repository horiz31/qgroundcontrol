...
Item {
    ...
    property bool insIdParamAvailable:              factPanelController.parameterExists(-1, "INS_ACC_ID")
    ...
    property Fact ins1Id:                           insIdParamAvailable ? factPanelController.getParameterFact(-1, "INS_ACC_ID") : _noFact
