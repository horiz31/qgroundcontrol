...
public:
    ...
    void                guidedModeGotoLocationAndAltitude        (Vehicle* vehicle, const QGeoCoordinate& gotoCoord, double altitudeRel, bool isClockwise) override;
    ...
    QString             rtlFlightMode                   (void) const override { return QString("Rally"); }
    ...
    QString             brandImageIndoor                (const Vehicle* vehicle) const override { Q_UNUSED(vehicle); return QStringLiteral("");} //qmlimages/APM/VolocommImage"); }  //no image at all
    QString             brandImageOutdoor               (const Vehicle* vehicle) const override { Q_UNUSED(vehicle); return QStringLiteral("");} //qmlimages/APM/VolocommImage"); }
